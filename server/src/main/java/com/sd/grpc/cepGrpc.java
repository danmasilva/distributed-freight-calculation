...
public final class cepGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.sd.grpc.CepOuterClass.CreateRequest,
      com.sd.grpc.CepOuterClass.APIResponse> getCreateMethod;
  ...
  public static io.grpc.MethodDescriptor<com.sd.grpc.CepOuterClass.CreateRequest,
      com.sd.grpc.CepOuterClass.APIResponse> getCreateMethod() {
    io.grpc.MethodDescriptor<com.sd.grpc.CepOuterClass.CreateRequest, com.sd.grpc.CepOuterClass.APIResponse> getCreateMethod;
    if ((getCreateMethod = cepGrpc.getCreateMethod) == null) {
      synchronized (cepGrpc.class) {
        if ((getCreateMethod = cepGrpc.getCreateMethod) == null) {
          cepGrpc.getCreateMethod = getCreateMethod = 
              io.grpc.MethodDescriptor.<com.sd.grpc.CepOuterClass.CreateRequest, com.sd.grpc.CepOuterClass.APIResponse>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<com.sd.grpc.CepOuterClass.UpdateRequest,
      com.sd.grpc.CepOuterClass.APIResponse> getUpdateMethod;
  ...
  public static io.grpc.MethodDescriptor<com.sd.grpc.CepOuterClass.UpdateRequest,
      com.sd.grpc.CepOuterClass.APIResponse> getUpdateMethod() {
    io.grpc.MethodDescriptor<com.sd.grpc.CepOuterClass.UpdateRequest, com.sd.grpc.CepOuterClass.APIResponse> getUpdateMethod;
    if ((getUpdateMethod = cepGrpc.getUpdateMethod) == null) {
      synchronized (cepGrpc.class) {
        if ((getUpdateMethod = cepGrpc.getUpdateMethod) == null) {
          cepGrpc.getUpdateMethod = getUpdateMethod = 
              io.grpc.MethodDescriptor.<com.sd.grpc.CepOuterClass.UpdateRequest, com.sd.grpc.CepOuterClass.APIResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "cep", "update"))
              .setSampledToLocalTracing(true)
  ...
  private static volatile io.grpc.MethodDescriptor<com.sd.grpc.CepOuterClass.DeleteRequest,
      com.sd.grpc.CepOuterClass.APIResponse> getDeleteMethod;
  ...
  public static io.grpc.MethodDescriptor<com.sd.grpc.CepOuterClass.DeleteRequest,
      com.sd.grpc.CepOuterClass.APIResponse> getDeleteMethod() {
    io.grpc.MethodDescriptor<com.sd.grpc.CepOuterClass.DeleteRequest, com.sd.grpc.CepOuterClass.APIResponse> getDeleteMethod;
    if ((getDeleteMethod = cepGrpc.getDeleteMethod) == null) {
      synchronized (cepGrpc.class) {
        if ((getDeleteMethod = cepGrpc.getDeleteMethod) == null) {
          cepGrpc.getDeleteMethod = getDeleteMethod = 
              io.grpc.MethodDescriptor.<com.sd.grpc.CepOuterClass.DeleteRequest, com.sd.grpc.CepOuterClass.APIResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "cep", "delete"))
              .setSampledToLocalTracing(true)
  ...
  public static final class cepBlockingStub extends io.grpc.stub.AbstractStub<cepBlockingStub> {
    ...
    /**
     */
    public com.sd.grpc.CepOuterClass.APIResponse create(com.sd.grpc.CepOuterClass.CreateRequest request) {
    ...
    /**
     */
    public com.sd.grpc.CepOuterClass.APIResponse update(com.sd.grpc.CepOuterClass.UpdateRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public com.sd.grpc.CepOuterClass.APIResponse delete(com.sd.grpc.CepOuterClass.DeleteRequest request) {
      return blockingUnaryCall(
  ...
  public static final class cepFutureStub extends io.grpc.stub.AbstractStub<cepFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sd.grpc.CepOuterClass.APIResponse> create(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sd.grpc.CepOuterClass.APIResponse> update(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sd.grpc.CepOuterClass.APIResponse> delete(
