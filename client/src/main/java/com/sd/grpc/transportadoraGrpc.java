...
public final class transportadoraGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.sd.grpc.TransportadoraOuterClass.CreateRequest,
      com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse> getCreateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "create",
      requestType = com.sd.grpc.TransportadoraOuterClass.CreateRequest.class,
      responseType = com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.sd.grpc.TransportadoraOuterClass.CreateRequest,
      com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse> getCreateMethod() {
    io.grpc.MethodDescriptor<com.sd.grpc.TransportadoraOuterClass.CreateRequest, com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse> getCreateMethod;
      ...
      synchronized (transportadoraGrpc.class) {
        if ((getCreateMethod = transportadoraGrpc.getCreateMethod) == null) {
          transportadoraGrpc.getCreateMethod = getCreateMethod = 
              io.grpc.MethodDescriptor.<com.sd.grpc.TransportadoraOuterClass.CreateRequest, com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.sd.grpc.TransportadoraOuterClass.UpdateRequest,
      com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse> getUpdateMethod;
  ...
  public static io.grpc.MethodDescriptor<com.sd.grpc.TransportadoraOuterClass.UpdateRequest,
      com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse> getUpdateMethod() {
    io.grpc.MethodDescriptor<com.sd.grpc.TransportadoraOuterClass.UpdateRequest, com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse> getUpdateMethod;
    if ((getUpdateMethod = transportadoraGrpc.getUpdateMethod) == null) {
      synchronized (transportadoraGrpc.class) {
        if ((getUpdateMethod = transportadoraGrpc.getUpdateMethod) == null) {
          transportadoraGrpc.getUpdateMethod = getUpdateMethod = 
              io.grpc.MethodDescriptor.<com.sd.grpc.TransportadoraOuterClass.UpdateRequest, com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
  ...
  private static volatile io.grpc.MethodDescriptor<com.sd.grpc.TransportadoraOuterClass.DeleteRequest,
      com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse> getDeleteMethod;
  ...
  public static io.grpc.MethodDescriptor<com.sd.grpc.TransportadoraOuterClass.DeleteRequest,
      com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse> getDeleteMethod() {
    io.grpc.MethodDescriptor<com.sd.grpc.TransportadoraOuterClass.DeleteRequest, com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse> getDeleteMethod;
    if ((getDeleteMethod = transportadoraGrpc.getDeleteMethod) == null) {
      synchronized (transportadoraGrpc.class) {
        if ((getDeleteMethod = transportadoraGrpc.getDeleteMethod) == null) {
          transportadoraGrpc.getDeleteMethod = getDeleteMethod = 
              io.grpc.MethodDescriptor.<com.sd.grpc.TransportadoraOuterClass.DeleteRequest, com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
  ...
  public static abstract class transportadoraImplBase implements io.grpc.BindableService {
    ...
    public void create(com.sd.grpc.TransportadoraOuterClass.CreateRequest request,
        io.grpc.stub.StreamObserver<com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse>(
  ...
  public static final class transportadoraBlockingStub extends io.grpc.stub.AbstractStub<transportadoraBlockingStub> {
    ...
    /**
     */
    public com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse create(com.sd.grpc.TransportadoraOuterClass.CreateRequest request) {
    ...
    /**
     */
    public com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse update(com.sd.grpc.TransportadoraOuterClass.UpdateRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse delete(com.sd.grpc.TransportadoraOuterClass.DeleteRequest request) {
      return blockingUnaryCall(
  ...
  public static final class transportadoraFutureStub extends io.grpc.stub.AbstractStub<transportadoraFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse> create(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse> update(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sd.grpc.TransportadoraOuterClass.APITransportadoraResponse> delete(
